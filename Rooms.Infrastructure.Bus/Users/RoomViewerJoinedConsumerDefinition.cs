...
/// <summary>
/// Определение потребителя для события UserSettingsChanged.
/// </summary>
public class UserSettingsChangedConsumerDefinition : ConsumerDefinition<UserSettingsChangedConsumer>
{
    /// <summary>
