...
public class SetupTwoFactorCommandHandler(UserManager<UserData> userManager)
    : IRequestHandler<SetupTwoFactorCommand, (UserData, string)>
{
    /// <summary>
    ...
    public async Task<(UserData, string)> Handle(SetupTwoFactorCommand request, CancellationToken cancellationToken)
    {
