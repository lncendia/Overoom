...
public class VerifySetupTwoFactorTokenCommandHandler(UserManager<UserData> userManager)
    : IRequestHandler<VerifySetupTwoFactorTokenCommand, IReadOnlyCollection<string>>
{
    ...
    /// <exception cref="UserNotFoundException">Вызывается, если предоставленный код не был верифицирован</exception>
