...
public class ResetTwoFactorCommandHandler(UserManager<UserData> userManager)
    : IRequestHandler<ResetTwoFactorCommand, UserData>
{
    /// <summary>
    ...
    public async Task<UserData> Handle(ResetTwoFactorCommand request, CancellationToken cancellationToken)
    {
