...
public class UpdateSecurityStampCommandHandler(UserManager<UserData> userManager) : IRequestHandler<UpdateSecurityStampCommand, UserData>
{
    /// <summary>
    ...
    public async Task<UserData> Handle(UpdateSecurityStampCommand request, CancellationToken cancellationToken)
    {
